...
ARG SESSION_HEADER_TOKEN_FIELD_NAME
ARG REVERSE_PROXY_CREATE_TOKEN_URL
...
ENV SESSION_HEADER_TOKEN_FIELD_NAME ${SESSION_HEADER_TOKEN_FIELD_NAME}
ENV REVERSE_PROXY_CREATE_TOKEN_URL ${REVERSE_PROXY_CREATE_TOKEN_URL}
